...
class Test
{
	public static void main(String arg[])throws Exception
	{
		...
		Runnable ob=()->System.out.println("childthread");
...
class Test
{
	public static void main(String arg[])throws Exception
	{
		...
		new Thread(()->System.out.println("childthread")).start();
		}
}
...
class Test
{
	public static void main(String arg[])
	{
		...
		new Thread(()->{int i; for(i=1;i<=5;i++)System.out.println("childthread1");}).start();

		new Thread(()->{int i; for(i=1;i<=5;i++)System.out.println("childthread2");}).start();
		}
}
